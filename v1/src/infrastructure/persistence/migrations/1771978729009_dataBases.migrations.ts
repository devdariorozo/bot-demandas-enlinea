...
export class DataBasesMigration1771978729009 implements MigrationInterface {
  public async up(queryRunner: QueryRunner): Promise<void> {
    await queryRunner.query(`
      CREATE TABLE data_bases (
        ...
        CONSTRAINT UQ_data_bases_env_port_camp UNIQUE (environment_type_id, portfolio_type_id, campaing_type_id),
        ...
        CONSTRAINT FK_data_bases_campaing_type
